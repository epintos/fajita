...
//			return new JType(from_type.singletonFrom(), to_type);
		...
		else if (str.equals("java_lang_ObjectArray->one JavaPrimitiveIntegerValue set->lone java_lang_Object+null"))
			return JType.OBJECT_ARRAY_CONTAINS_TYPE;
		else if (str.equals("java_lang_ObjectArray->one  seq java_lang_Object+null"))
			return JType.ALLOY_OBJECT_ARRAY_CONTAINS_TYPE;
		else if (str.equals("java_lang_IntArray->one JavaPrimitiveIntegerValue set->lone JavaPrimitiveIntegerValue"))
	...
	public String toString() {
		...
		if (specialType != null) {
			...
			case ITERATOR_CONTAINS:
				...
				break;
			case INT_ARRAY_CONTAINS:
				sb.append(javaLangPackage() + "IntArray -> one (JavaPrimitiveIntegerValue set -> lone JavaPrimitiveIntegerValue)");
				break;
			case OBJECT_ARRAY_CONTAINS:
				sb.append(javaLangPackage() + "ObjectArray -> one (JavaPrimitiveIntegerValue set -> lone (" + javaLangPackage() + "Object + null))");
				break;
			case ALLOY_INT_ARRAY_CONTAINS:
				sb.append(javaLangPackage() + "IntArray -> one (seq Int)");
				break;
			case ALLOY_OBJECT_ARRAY_CONTAINS:
