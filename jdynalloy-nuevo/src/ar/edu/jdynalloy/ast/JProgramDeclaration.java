...
public final class JProgramDeclaration implements JDynAlloyASTNode {
	...
	private final AlloyTyping varsResultOfArithmeticOperationsInContracts;
	private final List<AlloyFormula> predsEncodingValueOfArithmeticOperationsInContracts;
...
//			List<AlloyFormula> predsEncodingValueOfArithmeticOperationsInObjectsInvariants
			) {
		super();
