...
public class MCCTestTest_test8 {
    ...
    public void testtest8_0() {
        ...
        // Method Invocation
        Method method = getAccessibleMethod("roops.core.objectsInstrumented.MCCTest", "test8", true);
        try {
            method.invoke(instance, i_Integer_1);
        } catch (Exception e) {
            e.printStackTrace();
        } 
