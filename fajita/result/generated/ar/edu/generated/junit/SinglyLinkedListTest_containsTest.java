...
public class SinglyLinkedListTest_containsTest {
    ...
    public void testcontainsTest_0() {
        ...
        try {
            method.invoke(instance, instance, value_param_Object_1);
        } catch (Exception e) {
            e.printStackTrace();
        } 
    ...
    public void testcontainsTest_1() {
        ...
        updateValue(_SinglyLinkedListNode_1, "value", _Object_1);
        ...
        Method method = getAccessibleMethod("roops.core.objectsInstrumented.SinglyLinkedList", "containsTest", true);
        try {
            method.invoke(instance, list_SinglyLinkedList_1, value_param_SinglyLinkedListNode_2);
        } catch (Exception e) {
            e.printStackTrace();
        } 
    ...
    public void testcontainsTest_2() {
        ...
        updateValue(_SinglyLinkedListNode_2, "value", _SinglyLinkedListNode_3);
        updateValue(_SinglyLinkedListNode_1, "next", _SinglyLinkedListNode_2);
        
        roops.utilInstrumented.RoopsArray value_param_RoopsArray_1 = new roops.utilInstrumented.RoopsArray();
        updateValue(_SinglyLinkedListNode_1, "value", value_param_RoopsArray_1);
        updateValue(list_SinglyLinkedList_1, "header", _SinglyLinkedListNode_1);
        
        // Method Invocation
        Method method = getAccessibleMethod("roops.core.objectsInstrumented.SinglyLinkedList", "containsTest", true);
        try {
            method.invoke(instance, list_SinglyLinkedList_1, value_param_RoopsArray_1);
        } catch (Exception e) {
            e.printStackTrace();
        } 
    ...
    public void testcontainsTest_3() {
        ...
        updateValue(_SinglyLinkedListNode_3, "value", _SinglyLinkedList_2);
        updateValue(_SinglyLinkedListNode_2, "next", _SinglyLinkedListNode_3);
        updateValue(_SinglyLinkedListNode_2, "value", null);
        updateValue(_SinglyLinkedListNode_1, "next", _SinglyLinkedListNode_2);
        
        roops.utilInstrumented.RoopsArray _RoopsArray_1 = new roops.utilInstrumented.RoopsArray();
        updateValue(_SinglyLinkedListNode_1, "value", _RoopsArray_1);
        updateValue(list_SinglyLinkedList_1, "header", _SinglyLinkedListNode_1);
