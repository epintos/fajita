...
public class AllDefTestTest_test6 {
    ...
    public void testtest6_0() {
        ...
        // Method Invocation
        Method method = getAccessibleMethod("roops.core.objectsInstrumented.AllDefTest", "test6", true);
        try {
            method.invoke(instance, a_Integer_1);
        } catch (Exception e) {
            e.printStackTrace();
        } 
