...
public class SinglyLinkedListContains {
	...
	public boolean contains(int value_param) {
		...
		roops_goal_4 = variable_definition_8;
		roops_goal_5 = variable_definition_7;
		while (result == false && current != null) {
			boolean equalVal;
			variable_definition_9 = true;
			roops_goal_6 = variable_definition_4;
			...
			roops_goal_8 = variable_definition_9;
			roops_goal_9 = variable_definition_10;
			roops_goal_10 = variable_definition_11;
			if (equalVal == true) {
				result = true;
