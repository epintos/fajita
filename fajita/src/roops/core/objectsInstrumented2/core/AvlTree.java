...
import roops.core.objectsInstrumented2.core.roops.RoopsStack;
...
public class AvlTree {
	...
	private AvlNode search(final int x, final AvlNode arg) {
		AvlNode t = arg;
		while (t != null) {
	...
	private AvlNode searchMax(final AvlNode arg) {
		AvlNode t = arg;
		if (t == null) {
			{
				roops.util.Goals.reached(0, roops.util.Verdict.REACHABLE);
	...
	private AvlNode searchMin(final AvlNode arg) {
		AvlNode t = arg;
		if (t == null) {
			{
				roops.util.Goals.reached(0, roops.util.Verdict.REACHABLE);
