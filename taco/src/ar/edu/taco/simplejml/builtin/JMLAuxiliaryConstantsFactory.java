...
public abstract class JMLAuxiliaryConstantsFactory {
    ...
    private static JMLAddAuxiliaryConstants create_add_auxiliary_formulas(AlloyExpression left, AlloyExpression right, JVariableDeclaration varDeclResult, JVariableDeclaration varDeclOverflow, String predicateId) {
        ...
        List<AlloyExpression> predicate_arguments = Arrays.asList(left, right, new ExprVariable(add_result.getVariable()), new ExprVariable(add_overflow.getVariable()));
    ...
    public static JMLAddAuxiliaryConstants build_integer_add_auxiliary_constants(AlloyExpression left, AlloyExpression right) {
        ...
        String sk_add_result = build_result_aux(predicate_id, current_add_auxiliary_index);
        String sk_add_overflow = build_overflow_aux(predicate_id, current_add_auxiliary_index);
    ...
    public static JMLAddAuxiliaryConstants build_long_add_auxiliary_constants(AlloyExpression left, AlloyExpression right) {
        ...
        JVariableDeclaration var_decl_result = new JVariableDeclaration(new AlloyVariable(sk_add_result), JSignatureFactory.JAVA_PRIMITIVE_LONG_VALUE);
        JVariableDeclaration var_decl_overflow = new JVariableDeclaration(new AlloyVariable(sk_add_overflow), JSignatureFactory.BOOLEAN_TYPE);
    ...
    public static JMLAddAuxiliaryConstants build_float_add_auxiliary_constants(AlloyExpression left, AlloyExpression right) {
        ...
        String sk_add_compatibility = build_compatibility_aux(predicate_id, add_auxiliary_index);
        ...
        JVariableDeclaration var_decl_compatibility = new JVariableDeclaration(new AlloyVariable(sk_add_compatibility), JSignatureFactory.BOOLEAN_TYPE);
    ...
    private static JMLMinusAuxiliaryConstants create_sub_auxiliary_formulas(AlloyExpression left, AlloyExpression right, JVariableDeclaration varDeclResult, JVariableDeclaration varDeclOverflow, String predicateId) {
        ...
        List<AlloyExpression> predicate_arguments = Arrays.asList(left, right, new ExprVariable(sub_result.getVariable()), new ExprVariable(sub_overflow.getVariable()));
    ...
    public static JMLMinusAuxiliaryConstants build_integer_minus_auxiliary_constants(AlloyExpression left, AlloyExpression right) {
        ...
        String sk_add_result = build_result_aux(predicate_id, current_minus_auxiliary_index);
        String sk_add_overflow = build_overflow_aux(predicate_id, current_minus_auxiliary_index);
    ...
    public static JMLMinusAuxiliaryConstants build_long_minus_auxiliary_constants(AlloyExpression left, AlloyExpression right) {
        ...
        String sk_sub_result = build_result_aux(predicate_id, current_minus_auxiliary_index);
        String sk_sub_overflow = build_overflow_aux(predicate_id, current_minus_auxiliary_index);

        // create sk var declarations

        JVariableDeclaration var_decl_result = new JVariableDeclaration(new AlloyVariable(sk_sub_result), JSignatureFactory.JAVA_PRIMITIVE_LONG_VALUE);
    ...
    public static JMLMinusAuxiliaryConstants build_float_minus_auxiliary_constants(AlloyExpression left, AlloyExpression right) {
        ...
        String sk_sub_result = build_result_aux(predicate_id, current_minus_auxiliary_index);
        String sk_sub_compatibility = build_compatibility_aux(predicate_id, current_minus_auxiliary_index);
        ...
        JVariableDeclaration var_decl_compatibility = new JVariableDeclaration(new AlloyVariable(sk_sub_compatibility), JSignatureFactory.BOOLEAN_TYPE);
    ...
    public static JMLMultAuxiliaryConstants build_long_mult_auxiliary_constants(AlloyExpression left, AlloyExpression right) {
        ...
        String sk_mul_result = build_result_aux(predicateId, current_mul_auxiliary_index);
        String sk_mul_overflow = build_overflow_aux(predicateId, current_mul_auxiliary_index);
    ...
    private static JMLMultAuxiliaryConstants create_mult_auxiliary_formulas(AlloyExpression left, AlloyExpression right,
        ...
        ExprVariable mul_result = new ExprVariable(new AlloyVariable(sk_mul_result));
        ExprVariable mul_overflow = new ExprVariable(new AlloyVariable(sk_mul_overflow));

        
        List<AlloyExpression> predicate_arguments = Arrays.asList(left, right, new ExprVariable(mul_result.getVariable()), new ExprVariable(mul_overflow.getVariable()));
    ...
    private static JMLDivAuxiliaryConstants create_divide_auxiliary_formulas(AlloyExpression left, AlloyExpression right, 
        ...
        List<AlloyExpression> predicate_arguments = Arrays.asList(left, right, new ExprVariable(div_result.getVariable()), new ExprVariable(div_remainder.getVariable()));
    ...
    private static JMLModuloAuxiliaryConstants create_modulo_auxiliary_formulas(AlloyExpression left, AlloyExpression right, 
        ...
        ExprVariable mod_quotient = ExprVariable.buildExprVariable(sk_mod_quotient);
        ExprVariable mod_remainder = ExprVariable.buildExprVariable(sk_mod_remainder);

        List<AlloyExpression> predicate_arguments = Arrays.asList(left, right, new ExprVariable(mod_quotient.getVariable()), new ExprVariable(mod_remainder.getVariable()));
    ...
    public static JMLModuloAuxiliaryConstants build_integer_modulo_auxiliary_constants(AlloyExpression left, AlloyExpression right) {
        ...
        String sk_mod_quotient = build_result_aux(predicate_id, mod_auxiliary_index);
        String sk_mod_remainder = build_remainder_aux(predicate_id, mod_auxiliary_index);

        JVariableDeclaration var_decl_quotient = new JVariableDeclaration(new AlloyVariable(sk_mod_quotient), JSignatureFactory.JAVA_PRIMITIVE_INTEGER_VALUE);
        JVariableDeclaration var_decl_remainder = new JVariableDeclaration(new AlloyVariable(sk_mod_remainder), JSignatureFactory.JAVA_PRIMITIVE_INTEGER_VALUE);
    ...
    public static JMLModuloAuxiliaryConstants build_long_modulo_auxiliary_constants(AlloyExpression left, AlloyExpression right) {
        ...
        JVariableDeclaration var_decl_quotient = new JVariableDeclaration(new AlloyVariable(sk_mod_quotient), JSignatureFactory.JAVA_PRIMITIVE_LONG_VALUE);
        JVariableDeclaration var_decl_remainder = new JVariableDeclaration(new AlloyVariable(sk_mod_remainder), JSignatureFactory.JAVA_PRIMITIVE_LONG_VALUE);
